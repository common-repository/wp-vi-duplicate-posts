...
function wvpd_admin_js() {
    wp_register_script( 'wvpd_admin_js', plugins_url('js/script.js', __FILE__), array('jquery'));
...
Enable checkbox for copy post/page into another post-types, in post/page edit screen you will get checkboxes for post-types. ", 'wvpd'); ?>
	...
	<center>
<div class="bottom">
		    <h3 id="download-comments-wvpd-1" class="title"><?php _e( 'Download Free Plugins', 'wvpd' ); ?></h3>
		     
     <div id="downloadtbl-comments-wvpd-1" class="togglediv">  
	<h3 class="company">
...
<div class="bottom">
		    <h3 id="donatehere-comments-wvpd-1" class="title"><?php _e( 'Donate Here', 'wvpd' ); ?></h3>
     <div id="donateheretbl-comments-wvpd-1" class="togglediv">  
...
<div class="bottom">
		    <h3 id="donatehere-comments-wvpd-2" class="title"><?php _e( 'Woocommerce Frontend Plugin', 'wvpd' ); ?></h3>
     <div id="donateheretbl-comments-wvpd-2" class="togglediv">  
...
<div class="bottom">
		    <h3 id="donatehere-comments-wvpd-3" class="title"><?php _e( 'Blue Frog Template', 'wvpd' ); ?></h3>
     <div id="donateheretbl-comments-wvpd-3" class="togglediv">  
     <p><?php _e( 'If you want to purchase , please click on below image.', 'wvpd' ); ?></p>
